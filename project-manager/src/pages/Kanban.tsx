...
export default function Kanban() {
	...
	return (
		<>
			...
			<main
				ref={parentRef}
				className={`relative min-h-screen bg-slate-100 max-w-none max-h-none flex flex-col items-center gap-[76px] px-5 pt-36 pb-7 sm:px-9 sm:pt-64 sm:pb-16 sm:gap-16 lg:py-9 lg:justify-center ${
			...
			>
				...
				>
					<div className="flex justify-between">
						<h1
							className={`${
								isOpen ? "block text-white text-base font-bold sm:text-xl" : "hidden"
							}`}
						>
							In this project
						</h1>
					...
					<div className={isOpen ? "flex gap-1" : "hidden"}>
						<div className="flex flex-col gap-2 w-[60%]">
							...
							<div className="bg-[#F6F6F6] pt-1 rounded-xl">
								<h1 className="text-xs text-roxo font-bold text-center sm:text-[13px]">Total estimated time</h1>
				...
				<div
					id="flag"
					className={`bg-preto-50 w-full px-[10px] pb-3 pt-[6px] rounded-2xl z-10 sm:px-5 sm:py-[18px] lg:hidden ${
						isOpen ? "hidden" : ""
					}`}
				>
