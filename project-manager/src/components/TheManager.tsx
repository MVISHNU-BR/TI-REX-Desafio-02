...
const TheManager = () => {
  return (
    <div className="bg-azul-escuro text-white lg:items-center py-[60px] flex flex-col gap-[49px] xl:flex xl:flex-col overflow-hidden">
      <div
        className="h-[252px] px-[20.5px] sm:px-[44px] lg:px-0 flex flex-col gap-6 md:w-[656px] md:h-[216px] md:mx-auto xl:w-[1100px] xl:h-[192px] xl:flex xl:flex-col xl:gap-6 xl:mx-[170px]
      "
      >
        ...
        <button className="mx-auto text-[15px] bg-white text-roxo w-[205px] rounded-lg h-9 sm:mx-0 md:w-[240px] md:text-base lg:w-[240px] lg:h-12 lg:font-semibold hover:bg-azul-dessaturado hover:text-white transition duration-200 ease-in-out">
          Learn More
        </button>
      </div>
      <CaroulselImages />
